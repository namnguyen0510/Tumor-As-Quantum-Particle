...
for f_idx in range(5):
    ...
    for _ in tqdm.tqdm(range(n_pred)):
        ...
        #print(t)
        print(S)
        fig.add_trace(go.Scatter(x=t.flatten().detach().cpu().numpy(),y = -S.log().detach().cpu().numpy(),mode = 'markers',name = 'Fold {}|Test'.format(f_idx),
...
fig.update_layout(width = 1600, height = 500,yaxis_title = '<b>Response Scores</b><br>(rho)',
...
fig.write_image('result_TCGA_CV5_RISK_{}.pdf'.format(n_pred))
